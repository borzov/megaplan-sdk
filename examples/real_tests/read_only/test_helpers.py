...
async def test_make_employee_entity():
    ...
    try:
        async with MegaplanClient(
            ...
            print(f"   contentType: {entity.get('contentType')}")
            print(f"   id: {entity.get('id')}")

            if entity.get("contentType") == "Employee" and entity.get("id") == employee_id:
...
async def test_make_task_entity():
    ...
    try:
        async with MegaplanClient(
            ...
            if entity.get("contentType") == "Task" and entity.get("id") == task_id:
                print_success("Helper функция работает корректно")
                return True
            else:
                print_warning("Helper функция вернула неверные данные")
...
async def test_make_project_entity():
    ...
    try:
        async with MegaplanClient(
            ...
            if entity.get("contentType") == "Project" and entity.get("id") == project_id:
                print_success("Helper функция работает корректно")
                return True
            else:
                print_warning("Helper функция вернула неверные данные")
...
async def test_make_deal_entity():
    ...
    try:
        async with MegaplanClient(
            ...
            if entity.get("contentType") == "Deal" and entity.get("id") == deal_id:
                print_success("Helper функция работает корректно")
                return True
            else:
                print_warning("Helper функция вернула неверные данные")
...
async def test_make_contractor_entity():
    ...
    try:
        async with MegaplanClient(
            ...
            # Contractor can be ContractorCompany or ContractorHuman, but helper returns "Contractor"
            if entity.get("contentType") == "Contractor" and entity.get("id") == contractor_id:
                print_success("Helper функция работает корректно")
                return True
            else:
                print_warning("Helper функция вернула неверные данные")
